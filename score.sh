...
python score_networks.py --save_loc results/score/cifar100 --save_string all_score --valid --augtype none --repeat 1 --sigma 0.05 --nasspace nasbench201 --batch_size 128 --GPU 0 --dataset cifar100 --data_loc ../cifar100/
...
python score_networks.py --save_loc results/score/cifar10-test --save_string all_score --test --augtype none --repeat 1 --sigma 0.05 --nasspace nasbench201 --batch_size 128 --GPU 0 --n_samples 50 --dataset cifar10
python score_networks.py --save_loc results/score/cifar100-test --save_string all_score --test --augtype none --repeat 1 --sigma 0.05 --nasspace nasbench201 --batch_size 128 --GPU 0 --dataset cifar100 --data_loc ../cifar100/
python score_networks.py --save_loc results/score/ImageNet16-120-test --save_string all_score --test --augtype none --repeat 1 --sigma 0.05 --nasspace nasbench201 --batch_size 128 --GPU 0 --dataset ImageNet16-120 --data_loc ../ImageNet16/
<<block
