    ...
    \begin{table}[tb]
        ...
        \resizebox{0.48\textwidth}{!}{
            \begin{tabular}{cccc}\toprule
                ...
                \bf{Rank-Based (ours)}       & X        & X         & X     \\ \bottomrule
...
% method
    ...
    The proposed rank-based score function is outlined in \xalg{alg:rank-based}. The first step is to evaluate the 
    ...
    The result of natsbenchsss is shown in \xtab{table:overall_sss}.
    \begin{table*}[htb]
        %\normalsize
        %\centering
    ...
    The result of nasbench201 is shown in \xtab{table:overall_201}.
    \begin{table*}[htb]
        %\normalsize
        %\centering
        \newcommand{\z}{\phantom{0}}
