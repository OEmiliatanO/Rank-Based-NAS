...
\begin{abstract}
    ...
    %takes trainability into account. %%
...
% introduction
    ...
    %\cite{tanaka2020pruning}. Tanaka et al. proposed %%
...
% what is unknown?
    % 做成圖表放第一頁
    However, \xtab{table:corr_score} shows most score functions suffer 
    ...
    searching algorithm, we can not find the optimal architecture. %% ... cannot find optimal, the main reason is ...
...
% method
    ...
    score functions. \xsec{sec:proposed} gives a detailed 
    ...
    prospect are gived in \xsec{sec:conclusion}.
    ...
    %%, Wu et al. proposed using noise immunity (NI) to 
    ...
    % 3 search spaces merge
    \subsection{Simulation Results}
    The simulation results in NATS-Bench-SSS \cite{Dong_2021} is shown in \xtab{table:overall_sss}. The proposed 
    ...
    In NATS-Bench-TSS \cite{Dong_2021}, \xtab{table:overall_201} compares \palg{} with the other non-weight sharing algorithms, six 
    ...
    Lastly, the result of the experiment in NAS-Bench-101 \cite{ying2019nasbench101} is shown in \xtab{table:overall_101}. 
    It compares rank function and \palg{} with two non-weight sharing algorithms and two weight 
    sharing algorithms. ENAS has the best performance, while the computation time is the highest. 
    Compared \palg{} with other training-free score functions, the performance and stability are better 
    than others with a reasonable time cost. 
    ...
    \begin{table*}[t]
        ...
        \begin{tabular}{@{}lrcc@{}}\toprule
            ...
            ENAS                & $22,325$   & $93.83 \pm 0.28$ & $93.34 \pm 0.26$ \\ \midrule
                                &            & \textbf{Training-free}      &       \\
            RS-NI (N=1,000)         & $280$  & $92.89 \pm 2.10$ & $92.55 \pm 1.33$ \\ 
            RS-NASWOT (N=1,000)     & $162$  & $92.27 \pm 6.60$ & $92.10 \pm 4.44$ \\ 
            RS-LogSynFlow (N=1,000) & $105$  & $91.81 \pm 1.52$ & $91.21 \pm 1.71$ \\ 
            RS-rank (ours) (N=1000) & $516$  & $92.44 \pm 1.42$ & $91.94 \pm 2.01$ \\ 
