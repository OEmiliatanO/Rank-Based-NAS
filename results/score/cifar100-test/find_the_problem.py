...
ninaswot = np.load("ninaswot_nasbench201_cifar100_none_0.05_1_False_128_1_1.npy")
logsynflow  = np.load("logsynflow_nasbench201_cifar100_none_0.05_1_False_128_1_1.npy")
ntk      = np.load("ntk_nasbench201_cifar100_none_0.05_1_False_128_1_1.npy")
logsynflow *= 0.1
tot      = ninaswot + ntk + logsynflow
acc      = np.load("all_score_accs_nasbench201_cifar100_False.npy")

the_problems = np.load("acc-ninaswot_add_ntk_add_logsynflow_the_problems_nasbench201_cifar100_none_0.05_1_False_128_1_1.npy")
