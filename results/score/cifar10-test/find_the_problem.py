...
ninaswot = np.load("ninaswot_nasbench201_cifar10_none_0.05_1_False_128_1_1.npy")
logsynflow  = np.load("logsynflow_nasbench201_cifar10_none_0.05_1_False_128_1_1.npy")
ntk      = np.load("ntk_nasbench201_cifar10_none_0.05_1_False_128_1_1.npy")
#logsynflow *= 0.1
tot      = ninaswot + ntk + logsynflow
acc      = np.load("all_score_accs_nasbench201_cifar10_False.npy")

#the_problems = np.load("acc-ninaswot_add_ntk_add_logsynflow_the_problems_nasbench201_cifar10_none_0.05_1_False_128_1_1.npy")
the_problems = np.load("acc-ninaswot_the_problems_nasbench201_cifar10_none_0.05_1_False_128_1_1.npy")
...
def sort_and_prune(arches, what, proposition):
    ...
    print(f"no.\tacc\tninas\tentropy\tntk\ttot")
    for this in arches:
        print(f"{this.no}\t{this.acc:.3f}\t{this.ninaswot:>.3f}\t{this.synflow:>.3f}\t{this.ntk:>.3f}\t{this.tot:>.3f}")
    return arches
